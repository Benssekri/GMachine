			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card-body">
						...
						<p class="card-description">Machine entre deux Dates</p>
							
							<div class="form-group">
								<input required type="date" class="form-control form-control-user" name="mdate" id="mdate1">
							</div>
							<div class="form-group">
								<input required type="date" class="form-control form-control-user" name="mdate" id="mdate2">
							</div>
							<div id="mod">
								<button type="button" class="btn btn-primary mr-2 " onclick="afficher()">Afficher</button>
							</div>
						<br>
						<div class="card">
							<div class="card-body">
